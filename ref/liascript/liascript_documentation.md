...
>[!NOTE]
> Source documentation is available: https://github.com/LiaScript/LiaScript/blob/development/README.md
...
![screenshot of the LiaBooks repository](https://raw.githubusercontent.com/liaScript/docs/master/img/screenshot_liabooks.png)
...
![screenshot of the LiaTemplates repository](https://raw.githubusercontent.com/liaScript/docs/master/img/screenshot_liatemplates.png)
...
information-section as well as within the home-section.
                            ...
                            {{1}}
![Screencast of meta-information usage](https://raw.githubusercontent.com/liaScript/docs/master/img/meta-information.gif)
...
* __mailto:__
  ...
  `[Write me a Mail](https://raw.githubusercontent.com/liaScript/docs/master/mailto:LiaScript@web.de)` --> [Write me a Mail](https://raw.githubusercontent.com/liaScript/docs/master/mailto:LiaScript@web.de)

  `[LiaScript\@web.de](https://raw.githubusercontent.com/liaScript/docs/master/mailto:LiaScript@web.de)` --> [LiaScript\@web.de](https://raw.githubusercontent.com/liaScript/docs/master/mailto:LiaScript@web.de)
...
* __tel:__
  ...
  `[Call me](https://raw.githubusercontent.com/liaScript/docs/master/tel:+49-12345-67890)` --> [Call me](https://raw.githubusercontent.com/liaScript/docs/master/tel:+49-12345-67890)

  `[+49-12345-67890](https://raw.githubusercontent.com/liaScript/docs/master/tel:+49-12345-67890)` --> [+49-12345-67890](https://raw.githubusercontent.com/liaScript/docs/master/tel:+49-12345-67890)
...
**Image-notation: !\[{1}{`alt-text`}\](https://raw.githubusercontent.com/liaScript/docs/master/{2}{url} {3}{"optional sub-title"})**

                            {{2}}
* relative URL: `![Beautiful Lenna](https://raw.githubusercontent.com/liaScript/docs/master/img/lenna.jpg)`

  ![Beautiful Lenna](https://raw.githubusercontent.com/liaScript/docs/master/img/lenna.jpg)
...
``` markdown
![Beautiful Lenna](https://raw.githubusercontent.com/liaScript/docs/master/img/lenna.jpg "subtitles are allowed too")
...
![Beautiful Lenna](https://raw.githubusercontent.com/liaScript/docs/master/img/lenna.jpg "subtitles are allowed too") Lorem ipsum dolor
...
``` markdown
![img1](https://raw.githubusercontent.com/liaScript/docs/master/url) ![img2](https://raw.githubusercontent.com/liaScript/docs/master/url) ![img3](https://raw.githubusercontent.com/liaScript/docs/master/url)
![img4](https://raw.githubusercontent.com/liaScript/docs/master/url)
![img5](https://raw.githubusercontent.com/liaScript/docs/master/url)
```
...
**Movie-notation: `!?[alt-text](https://raw.githubusercontent.com/liaScript/docs/master/movie-url)`**

- YouTube: `!?[The Future of Programming](https://www.youtube.com/watch?v=8pTEmbeENF4)`

  !?[The Future of Programming](https://www.youtube.com/watch?v=8pTEmbeENF4)

- relative path: `!?[Something about math](https://raw.githubusercontent.com/liaScript/docs/master/vid/math.mp4)`

  !?[Something about math](https://raw.githubusercontent.com/liaScript/docs/master/vid/math.mp4)
...
``` markdown
![img](https://raw.githubusercontent.com/liaScript/docs/master/url) ?[audio](https://raw.githubusercontent.com/liaScript/docs/master/url) !?[movie](https://raw.githubusercontent.com/liaScript/docs/master/url)
??[something else](https://raw.githubusercontent.com/liaScript/docs/master/url)
??[something else](https://raw.githubusercontent.com/liaScript/docs/master/url)
```
...
![Demo of a table editor](https://raw.githubusercontent.com/liaScript/docs/master/img/table-editing.gif)
...
![Beautiful Lenna](https://raw.githubusercontent.com/liaScript/docs/master/img/lenna.jpg "Image of Lenna with a hat")
...
<!--
...
link: https://raw.githubusercontent.com/liaScript/docs/master/file.css
...
-->
...
![image](https://raw.githubusercontent.com/liaScript/docs/master/..Creative-Tail-Animal-lion.svg)<!--
style = "width: 300px;
         border: 10px solid;"
...
```markdown
![The Wave](https://raw.githubusercontent.com/liaScript/docs/master/..ave_off_Kanagawa_%28Kanagawa_oki_nami.jpg "without attribute injection")
...
the video. The stop-parameter should be optional.
                            ...
                            {{1}}
``` markdown
!?[Something about math](https://raw.githubusercontent.com/liaScript/docs/master/vid/math.mp4#t=4,12)<!--
autoplay="true"
muted="true"
-->
```
...
of course it will be muted.
                 ...
                 {{2}}
!?[Something about math](https://raw.githubusercontent.com/liaScript/docs/master/vid/math.mp4#t=4,10)<!--
autoplay="true"
muted="true" -->
...
`&mute=false` as it is depicted below:
                            ...
                            {{1}}
`!?[Multimedia](https://raw.githubusercontent.com/liaScript/docs/master/url/...?autoplay=1&mute=1&start=1895&end=1905)`
...
`Inline Footnote [^x](https://raw.githubusercontent.com/liaScript/docs/master/__explanation__ in one line)` => Inline Footnote[^x](https://raw.githubusercontent.com/liaScript/docs/master/__explanation__ in one line)
...
If you are on the LiaScript website and if you have a course started, you can directly switch to the classroom settings by clicking onto the share button.
          ...
          {{0-1}}
![Open Classroom](https://raw.githubusercontent.com/liaScript/docs/master/img/classroom1.png)
...
Some services like [Beaker](https://beakerbrowser.com) require you to run your course from another browser, or you will have different settings.
          ...
          {{1-2}}
![Classroom Settings](https://raw.githubusercontent.com/liaScript/docs/master/img/classroom2.png)
...
The passwords are optional.
          ...
          {{2-3}}
![Classroom with GunDB](https://raw.githubusercontent.com/liaScript/docs/master/img/classroom3.png)
...
In this case, they will have to repeat these steps.
          ...
          {{3-4}}
![Open Classroom](https://raw.githubusercontent.com/liaScript/docs/master/img/classroom4.png)
...
Again, the URL of the course will change back to the original representation.
           ...
           {{4}}
![Open Classroom](https://raw.githubusercontent.com/liaScript/docs/master/img/classroom5.png)
...
![translations](https://raw.githubusercontent.com/liaScript/docs/master/img/translation.png "Screenshot of a translation to Hebrew with Google-translate.")
...
your comment.
?[⏯](https://raw.githubusercontent.com/liaScript/docs/master/recording/audio_1.mp3)
...
```
    ...
    --{{1}}--
?[⏯](https://raw.githubusercontent.com/liaScript/docs/master/recording/audio_2.mp3)
...
Or, add it to the front.
    ...
    --{{1}}--
?[⏯](https://raw.githubusercontent.com/liaScript/docs/master/recording/audio_3.mp3)
...
#### Video
    ...
    --{{0}}--
!?[⏯](https://raw.githubusercontent.com/liaScript/docs/master/recording/video1.webm)
...
The user can choose where to place the overlaid video and adjust its size based on their screen size, orientation, and resolution.
    ...
    --{{1}}--
!?[⏯](https://raw.githubusercontent.com/liaScript/docs/master/recording/video2.webm)
...
!?[⏯](https://raw.githubusercontent.com/liaScript/docs/master/recording/video3.webm)
```
...
`@[macro-call(with,parameters)](https://raw.githubusercontent.com/liaScript/docs/master/AndURLs "ignored")`
...
@[load.java](https://raw.githubusercontent.com/liaScript/docs/master/App.java)

@[load(java)](https://raw.githubusercontent.com/liaScript/docs/master/App.java)

will return an error message

@[load.java](https://raw.githubusercontent.com/liaScript/docs/master/DoesNotExist.java)
````
...
@[load.java](https://raw.githubusercontent.com/liaScript/docs/master/example/App.java)

@[load(java)](https://raw.githubusercontent.com/liaScript/docs/master/example/App.java)

will return an error message

@[load.java](https://raw.githubusercontent.com/liaScript/docs/master/example/DoesNotExist.java)
...
![Author information](https://raw.githubusercontent.com/liaScript/docs/master/img/author.png)
...
![Comment information](https://raw.githubusercontent.com/liaScript/docs/master/img/comment.png)
...
![Date information](https://raw.githubusercontent.com/liaScript/docs/master/img/date.png)
...
![Email information](https://raw.githubusercontent.com/liaScript/docs/master/img/email.png)
...
-->
```
![Edit information](https://raw.githubusercontent.com/liaScript/docs/master/img/edit.png)
...
![Home-Screen](https://raw.githubusercontent.com/liaScript/docs/master/img/home-screen.png)
...
![Changed icon](https://raw.githubusercontent.com/liaScript/docs/master/img/icon.png)
...
attribute: [AlaSQL](https://alasql.org)
  by [Andrey Gershun](https://raw.githubusercontent.com/liaScript/docs/master/agershun@gmail.com)
  & [Mathias Rangel Wulff](https://raw.githubusercontent.com/liaScript/docs/master/m@rawu.dk)
...
![Attribution](https://raw.githubusercontent.com/liaScript/docs/master/img/attribute.png)
...
![Repository information](https://raw.githubusercontent.com/liaScript/docs/master/img/repository.png)
...
__Note that not all voices are supported equally, and the quality may vary between different operating systems and browsers.__
    ...
    {{1}}
![Browser TTS](https://raw.githubusercontent.com/liaScript/docs/master/img/tts.png)
...
![Show Translations](https://raw.githubusercontent.com/liaScript/docs/master/img/translate.png)
...
![Version information](https://raw.githubusercontent.com/liaScript/docs/master/img/version.png)
...
The default mode is determined by the user settings.
      ...
      {{1}}
![User modes](https://raw.githubusercontent.com/liaScript/docs/master/img/modes.png)
...
![dark and light](https://raw.githubusercontent.com/liaScript/docs/master/img/dark.png)
...
![classroom settings](https://raw.githubusercontent.com/liaScript/docs/master/img/classroom.png)
...
![sharing options](https://raw.githubusercontent.com/liaScript/docs/master/img/sharing.png)
...
![translate with google](https://raw.githubusercontent.com/liaScript/docs/master/img/translateWithGoogle.png)
